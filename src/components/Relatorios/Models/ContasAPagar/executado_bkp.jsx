...
class TabelaDadosContasAPagarExecutado extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      acumulativoMensal_debito: props.acumulativoMensal_debito || [],
      acumulativoMensal_credito: props.acumulativoMensal_credito || [],
      expandedCentroCusto: null, // Para controle de expansão
